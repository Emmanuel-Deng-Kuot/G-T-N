    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 relative z-10 text-center lg:text-left">
          <h1 className="text-lg md:text-4xl font-body text-slate-900 mb-4">
            Our products
          </h1>

          <p className="text-lg md:text-xl font-nav text-slate-400 leading-relaxed max-w-lg mx-auto lg:mx-0">
